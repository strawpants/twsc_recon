...
%  
%  Here, the PCA, ICA, LS, ARX, ANN, and MLR methods are applied to a specific region
%--------------------------------------------------------------------------
% AUTHOR:
%   Fupeng Li
...
%%   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % ICA, PCA, and LS of GRACE TWSC in a specific region
% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
...
for i=1:mode
    ...
    LS_TWS(:,:,i)=LS_output;            %Decomposed results from ICA and LS
end
for i=1:mode
    [LS_output]=LS(time1,T1_TWS(:,i),s);
    LS1_TWS(:,:,i)=LS_output;           %Decomposed results from PCA and LS
end
%% % % % %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % % % % ICA, PCA, and LS of SST in the South Atlantic
% % % % % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load 2001_COBE_SST.mat                       %load the sea surface temperature data
...
%% % % %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % ICA of SST in the South Pacific
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% %  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA, PCA, and LS of Temperature in a specific region
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% % %  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA, PCA, and LS of CPC_monthly in a specific region
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % ICA, PCA, and LS of CPC_daily_precipitation in a specific region
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         tn
    ...
    for j=1:t1
        ...
        R1=corrcoef(LS_P(7:189,k),LS_TWS(:,7,q));
        R2(tn,k,q)=R1(2,1);
        if (R(k,q)<abs(R1(2,1)))
        R(k,q)=abs(R1(2,1));
        tt(k,q)=tn;
        ...
        R1=corrcoef(LS1_P(7:189,k),LS1_TWS(:,7,q));
        R22(tn,k,q)=R1(2,1);
        ...
        R1=corrcoef(LS_Pi(7:189,k),LS_TWS(:,6,q));
        Ri2(tn,k,q)=R1(2,1);
        ...
        R1=corrcoef(LS1_Pi(7:189,k),LS1_TWS(:,6,q));
        Ri22(tn,k,q)=R1(2,1);
...
ir=230;%number of inter-annual/residual
ss=130;%number of seasonal
end
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:mode
    for j=1:ir
    RR=corrcoef(LS_TWS(:,6,i),Ti_intup1(7:189,j));
    Ri_input1(j,i)=RR(1,2);
    RR=corrcoef(LS1_TWS(:,6,i),Ti1_intup1(7:189,j));
...
for i=1:mode
    for j=1:ir
    RR=corrcoef(LS_TWS(:,7,i),Tr_intup1(7:189,j));
    Rr_input1(j,i)=RR(1,2);
    RR=corrcoef(LS1_TWS(:,7,i),Tr1_intup1(7:189,j));
...
for i=1:mode
    for j=1:ss
    RR=corrcoef(LS_TWS(:,3,i),Ts_intup1(7:189,j));
    Rs_input1(j,i)=RR(1,2);
    RR=corrcoef(LS1_TWS(:,3,i),Ts1_intup1(7:189,j));
...
for m=-3:3;    %search for the best time lag from -3 to 3
    RR=corrcoef(LS_TWS(:,6,i),Ti_input(7+m:189+m,j,i));
    if (abs(Rii(j,i))<abs(RR(1,2)))
        Rii(j,i)=RR(1,2);
        TDi(j,i)=m;
    end
    RR=corrcoef(LS1_TWS(:,6,i),Ti1_input(7+m:189+m,j,i));
...
for i=1:mode
    for j=1:ss
        ...
        Rss1(j,i)=0;
for m=-3:3;    %search for the best time lag from -3 to 3
    RR=corrcoef(LS_TWS(:,3,i),Ts_input(7+m:189+m,j,i));
    if (abs(Rss(j,i))<abs(RR(1,2)))
        Rss(j,i)=RR(1,2);
        TDs(j,i)=m;
    end
    RR=corrcoef(LS1_TWS(:,3,i),Ts1_input(7+m:189+m,j,i));
...
for i=1:mode
    for j=1:ir
        ...
        Rrr1(j,i)=0;
for m=-3:3;    %search for the best time lag from -3 to 3
    RR=corrcoef(LS_TWS(:,7,i),Tr_input(7+m:189+m,j,i));
    if (abs(Rrr(j,i))<abs(RR(1,2)))
        Rrr(j,i)=RR(1,2);
        TDr(j,i)=m;
    end
    RR=corrcoef(LS1_TWS(:,7,i),Tr1_input(7+m:189+m,j,i));
...
n=500;               % times of repetition of ANN process
%%%%%%%%%%%%%%%%
...
%-------------------------reconstruction of IC temporal modes----------------------------------
      ANN_T(:,i,k)              =    ANNPred_Ti(:,i,k)+ANNPred_Tr(:,i,k)+ANNPred_Ts(:,i,k)+Yl(Cut(k)-L1+1:Cut(k)+L2,1,i);
      ARX_T(:,i,k)              =    ARXPredi(:,i)+ARXPredr(:,i)+ARXPreds(:,i)+Yl(Cut(k)-L1+1:Cut(k)+L2,1,i);
      ALR_T(:,i,k)              =    ALRPredi(:,i)+ALRPredr(:,i)+ALRPreds(:,i)+Yl(Cut(k)-L1+1:Cut(k)+L2,1,i);
      TWS_T(:,i,k)              =    Yi(Cut(k)-L1+1:Cut(k)+L2,1,i)+Yr(Cut(k)-L1+1:Cut(k)+L2,1,i)+Ys(Cut(k)-L1+1:Cut(k)+L2,1,i)+Yl(Cut(k)-L1+1:Cut(k)+L2,1,i);
...
dlmwrite('SIMU_LS_ALR_ICA_RMS.txt', ValALRT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_LS_ALR_PCA_RMS.txt', ValALRT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_LS_ANN_ICA_RMS.txt', ValANNT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_LS_ANN_PCA_RMS.txt', ValANNT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_LS_ARX_ICA_RMS.txt', ValARXT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_LS_ARX_PCA_RMS.txt', ValARXT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
%----------------------output the prediction uncertainties at each grids---------------------------------
dlmwrite('PRE_LS_ALR_ICA_RMS_AVE.txt', ALRT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ALR_PCA_RMS_AVE1.txt', ALRT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ANN_ICA_RMS_AVE.txt', ANNT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ANN_PCA_RMS_AVE1.txt', ANNT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')% % %
dlmwrite('PRE_LS_ARX_ICA_RMS_AVET.txt', ARXT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ARX_PCA_RMS_AVET1.txt', ARXT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
%----------------------output the prediction correlation at each grids---------------------------------
dlmwrite('PRE_LS_ALR_ICA_R.txt', ALR_R_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ALR_PCA_R.txt', ALR_R_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ANN_ICA_R.txt', ANN_R_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ANN_PCA_R.txt', ANN_R_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ARX_ICA_R.txt', ARX_R_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_LS_ARX_PCA_R.txt', ARX_R_AVE1, 'delimiter', '\t','precision','%15.5f')