%% Function: Test the predicting uncertainties as described in Section 4.2.1.2 (see the paper)
%  
%  Here, the PCA, ICA, STL, ARX, ANN, and MLR methods are applied to a specific region
%
% AUTHOR:
%   Fupeng Li
...
%%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % ICA,PCA,and STL of GRACE TWSC in a specific region
% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
% load /Users/mac/Documents/MATLAB/data/MASCON/JPL_MASCON/JPL_interpo.mat
load CSR_interpo.mat                          % load the GRACE TWSC
[yv,xv]=textread('amazon_new.bln','%f %f');   % read the boundary data of a specific region (Amazon)
np =  12;                                     % STL parameter1
ni =  5;                                      % STL parameter2
no =  0;                                      % STL parameter3
nl =  13;                                     % STL parameter4
ns =  14;                                     % STL parameter5
nt =  19;                                     % STL parameter6
mode=6;                                       % set the number of selected EOF/IC modes
%------------------------read the GRACE TWSC in a specific region----------
[mm,nn,t1]=size(grid_data_grace);
for n1=1:t1   
  k=1;
  k1=1;
  for i=82:113                                %need to be adjusted when changing study region
  for j=276:312                               %need to be adjusted when changing study region
    lon((i-1)*180+j)=j-0.5;
    la((i-1)*180+j)=90.5-i;
...
[B_TWS,E_TWS,C_TWS,S1_TWS,T1_TWS] =  jadeR(a1_TWS,mode);%S1_TWS represents EOF spatial patterns; T1_TWS represents EOF temporal modes
T_TWS=B_TWS*a1_TWS;                                     %T_TWS represents IC temporal modes
S_TWS=a1_TWS*T_TWS'*inv(T_TWS*T_TWS');                  %S_TWS represents IC spatial patterns
T_TWS=T_TWS';
[BB_TWS,EE_TWS,CC_TWS,SS1_TWS,TT1_TWS] =  jadeR(a1_TWS(:,1:165),mode);
...
time1=time;
str_year1=str_year;
str_month1=str_month;
for i=1:mode
    [STL_output]=STL(str_year,str_month,time1,T_TWS(:,i),np,ni,no,nl,ns,nt);
    STL_TWS(:,:,i)=STL_output;         %Decomposed results from ICA and STL
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time1,T1_TWS(:,i),np,ni,no,nl,ns,nt);
    STL1_TWS(:,:,i)=STL_output;        %Decomposed results from PCA and STL
end
%% %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % ICA,PCA,and STL of SST in the South Atlantic
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load 2001_COBE_SST.mat                        %load the sea surface temperature
[yv1,xv1]=textread('SAtlantic1.bln','%f %f'); %boundary1(longitude>180)
[yv2,xv2]=textread('SAtlantic2.bln','%f %f'); %boundary2(longitude<180)
%------------------------read the SST in a specific region-----------------
[mm,nn,t1]=size(grid_data_grace);
k1=0;
for n2=1:t1
  k=1;
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_SAt(:,i),np,ni,no,nl,ns,nt);
    STL_SAt(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_SAt(:,i),np,ni,no,nl,ns,nt);
    STL1_SAt(:,:,i)=STL_output;
end
%% %  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % ICA,PCA,and STL of SST in the North Atlantic
% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_NAt(:,i),np,ni,no,nl,ns,nt);
    STL_NAt(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_NAt(:,i),np,ni,no,nl,ns,nt);
    STL1_NAt(:,:,i)=STL_output;
end
%% %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % ICA,PCA,and STL of SST in the NNorth Atlantic
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_NNAt(:,i),np,ni,no,nl,ns,nt);
    STL_NNAt(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_NNAt(:,i),np,ni,no,nl,ns,nt);
    STL1_NNAt(:,:,i)=STL_output;
end
%% % %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA,PCA,and STL of SST in the South Pacific
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_SPa(:,i),np,ni,no,nl,ns,nt);
    STL_SPa(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_SPa(:,i),np,ni,no,nl,ns,nt);
    STL1_SPa(:,:,i)=STL_output;
end
% % % %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA,PCA,and STL of SST in the North Pacific
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_NPa(:,i),np,ni,no,nl,ns,nt);
    STL_NPa(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_NPa(:,i),np,ni,no,nl,ns,nt);
    STL1_NPa(:,:,i)=STL_output;
end
%% %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % ICA,PCA,and STL of SST in the NGBsea
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_NGB(:,i),np,ni,no,nl,ns,nt);
    STL_NGB(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_NGB(:,i),np,ni,no,nl,ns,nt);
    STL1_NGB(:,:,i)=STL_output;
end
%% % %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA,PCA,and STL of SST in the Indian Ocean
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_Ind(:,i),np,ni,no,nl,ns,nt);
    STL_Ind(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_Ind(:,i),np,ni,no,nl,ns,nt);
    STL1_Ind(:,:,i)=STL_output;
end
%% %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % ICA,PCA,and STL of SST in the Mediterranean
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_Med(:,i),np,ni,no,nl,ns,nt);
    STL_Med(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_Med(:,i),np,ni,no,nl,ns,nt);
    STL1_Med(:,:,i)=STL_output;
end
% % % %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA,PCA,and STL of SST in the Blacksea
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_Black(:,i),np,ni,no,nl,ns,nt);
    STL_Black(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_Black(:,i),np,ni,no,nl,ns,nt);
    STL1_Black(:,:,i)=STL_output;
end
%% % %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA,PCA,and STL of SST in the Baltic
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_Baltic(:,i),np,ni,no,nl,ns,nt);
    STL_Baltic(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_Baltic(:,i),np,ni,no,nl,ns,nt);
    STL1_Baltic(:,:,i)=STL_output;
end
%% % %%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA,PCA,and STL of SST in the Hudson
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_Hudson(:,i),np,ni,no,nl,ns,nt);
    STL_Hudson(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_Hudson(:,i),np,ni,no,nl,ns,nt);
    STL1_Hudson(:,:,i)=STL_output;
end
%% %  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % ICA,PCA,and STL of Temperature in a specific region
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load 2001_land_temp.mat
[yv,xv]=textread('amazon_new.bln','%f %f');
%--------------read the land temperature in a specific region--------------
[mm,nn,t1]=size(grid_data_grace);
for n13=1:t1   
  k=1;
  for i=82:113
...
%----------------------STL Decomposition-----------------------------------
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T_TEM(:,i),np,ni,no,nl,ns,nt);
    STL_TEM(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_TEM(:,i),np,ni,no,nl,ns,nt);
    STL1_TEM(:,:,i)=STL_output;
end
%% %  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % ICA,PCA,and STL of CPC_monthly in a specific region
% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load  2001_CPC_Precip_Mon.mat 
[yv,xv]=textread('amazon_new.bln','%f %f');
%--------read the CPC monthly precipitation in a specific region-----------
s=18;
[mm,nn,t1]=size(grid_data_grace);
for n14=1:t1
  k=1;
...
time1=time;
for i=1:mode
    [STL_output]=STL(str_year,str_month,time1,T_CPC_M(:,i),np,ni,no,nl,ns,nt);
    STL_CPC_M(:,:,i)=STL_output;
end
for i=1:mode
    [STL_output]=STL(str_year,str_month,time,T1_CPC_M(:,i),np,ni,no,nl,ns,nt);
    STL1_CPC_M(:,:,i)=STL_output;
end
%%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % ICA,PCA,and STL of CPC_daily_precipitation in a specific region
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load 2002_CPC_Precip_daily.mat
[yv,xv]=textread('amazon_new.bln','%f %f');
%----------read the CPC daily precipitation in a specific region-----------
...
for i=1:16
    ...
    a1_pre(k:k+30,:)=T_CPC(k+n:k+30+n,:);
    a2_pre(k:k+30,:)=T1_CPC(k+n:k+30+n,:);
    t(k:k+30,1)=time(k+n:k+30+n,1);
    year22(k:k+30)=yea+i-1;
    for j=1:31
        day22(j+365*(i-1))=j;
    end
    end
...
for i=1:t2
        str_year2{i}    = num2str(year22(i));
        str_day2{i}   = num2str(day22(i),'%03u');
end
np =  365;
ni =  5;
no =  0;
...
for i=1:mode
    i
       ts1(:,1)=a1_pre(:,i);
       ts2(:,1)=a2_pre(:,i);
    [output]=STL(str_year2,str_day2,time,ts1,np,ni,no,nl,ns,nt);
    STL_CPC_daily(:,:,i)=output;
    [output]=STL(str_year2,str_day2,time,ts2,np,ni,no,nl,ns,nt);
    STL1_CPC_daily(:,:,i)=output;
end
% %**************************************************************************
%% % %  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % Reweighted precipitation temporal pattern inter annual and residual
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Reference: Humphrey V , Gudmundsson L , Seneviratne S I . Assessing Global 
% Water Storage Variability from GRACE: Trends, Seasonal Cycle, Subseasonal 
% Anomalies and Extremes[J]. Surveys in Geophysics, 2016, 37(2):357-395
tt1=time;
tt2=time1;
w=zeros(t2,t1);
for q=1:mode
...
Ti1_intup1(:,21:25)=STL1_Baltic(:,6,:);
...
Ti1_intup1(:,36:40)=STL1_Hudson(:,6,:);
...
Tr1_intup1(:,21:25)=STL1_Baltic(:,7,:);
...
Tr1_intup1(:,36:40)=STL1_Hudson(:,7,:);
...
Ts1_intup1(:,21:25)=STL1_Baltic(:,3,:);
...
Ts1_intup1(:,36:40)=STL1_Hudson(:,3,:);
...
Ti1_intup1(:,25:30)=STL1_Baltic(:,6,:);
...
Ti1_intup1(:,43:48)=STL1_Hudson(:,6,:);
...
Ti1_intup1(:,79:84)=STL1_Pi_out(:,1,:);
...
Ti1_intup1(:,85:90)=STL1_Pi_out(:,2,:);
...
Ti1_intup1(:,91:96)=STL1_Pi_out(:,3,:);
...
Ti1_intup1(:,97:102)=STL1_Pi_out(:,4,:);
...
Ti_intup1(:,103:108)=STL_Pi_out(:,5,:);
...
Ti1_intup1(:,103:108)=STL1_Pi_out(:,5,:);
...
Ti_intup1(:,109:114)=STL_Pi_out(:,6,:);
...
Ti1_intup1(:,109:114)=STL1_Pi_out(:,6,:);
...
Tr1_intup1(:,25:30)=STL1_Baltic(:,7,:); 
...
Tr1_intup1(:,43:48)=STL1_Hudson(:,7,:);
...
Tr1_intup1(:,97:102)=STL1_P_out(:,4,:);
...
Tr1_intup1(:,103:108)=STL1_P_out(:,5,:);
...
Tr1_intup1(:,109:114)=STL1_P_out(:,6,:);
...
Ts1_intup1(:,25:30)=STL1_Baltic(:,3,:);
...
Ts1_intup1(:,43:48)=STL1_Hudson(:,3,:);
...
Ti1_intup1(:,29:35)=STL1_Baltic(:,6,:);
...
Ti1_intup1(:,50:56)=STL1_Hudson(:,6,:);
...
Ti1_intup1(:,92:98)=STL1_Pi_out(:,1,:);
...
Ti1_intup1(:,99:105)=STL1_Pi_out(:,2,:);
...
Ti_intup1(:,106:112)=STL_Pi_out(:,3,:);
...
Ti1_intup1(:,106:112)=STL1_Pi_out(:,3,:);
...
Ti_intup1(:,113:119)=STL_Pi_out(:,4,:);
...
Ti1_intup1(:,113:119)=STL1_Pi_out(:,4,:);
...
Ti_intup1(:,120:126)=STL_Pi_out(:,5,:);
...
Ti1_intup1(:,120:126)=STL1_Pi_out(:,5,:);
...
Ti_intup1(:,127:133)=STL_Pi_out(:,6,:);
...
Ti1_intup1(:,127:133)=STL1_Pi_out(:,6,:);
...
Ti_intup1(:,134:140)=STL_Pi_out(:,7,:);
...
Ti1_intup1(:,134:140)=STL1_Pi_out(:,7,:);
...
Tr1_intup1(:,29:35)=STL1_Baltic(:,7,:);
...
Tr1_intup1(:,50:56)=STL1_Hudson(:,7,:);
...
Tr1_intup1(:,99:105)=STL1_P_out(:,2,:);
...
Tr1_intup1(:,106:112)=STL1_P_out(:,3,:);
...
Tr1_intup1(:,113:119)=STL1_P_out(:,4,:);
...
Tr1_intup1(:,120:126)=STL1_P_out(:,5,:);
...
Tr1_intup1(:,127:133)=STL1_P_out(:,6,:);
...
Tr1_intup1(:,134:140)=STL1_P_out(:,7,:);
...
Ts1_intup1(:,29:35)=STL1_Baltic(:,3,:);
...
Ts1_intup1(:,50:56)=STL1_Hudson(:,3,:);
...
Ti1_intup1(:,33:40)=STL1_Baltic(:,6,:);
...
Ti1_intup1(:,57:64)=STL1_Hudson(:,6,:);
...
Ti_intup1(:,105:112)=STL_Pi_out(:,1,:);
...
Ti1_intup1(:,105:112)=STL1_Pi_out(:,1,:);
...
Ti_intup1(:,113:120)=STL_Pi_out(:,2,:);
...
Ti1_intup1(:,113:120)=STL1_Pi_out(:,2,:);
...
Ti_intup1(:,121:128)=STL_Pi_out(:,3,:);
...
Ti1_intup1(:,121:128)=STL1_Pi_out(:,3,:);
...
Ti_intup1(:,129:136)=STL_Pi_out(:,4,:);
...
Ti1_intup1(:,129:136)=STL1_Pi_out(:,4,:);
...
Ti_intup1(:,137:144)=STL_Pi_out(:,5,:);
...
Ti1_intup1(:,137:144)=STL1_Pi_out(:,5,:);
...
Ti_intup1(:,145:152)=STL_Pi_out(:,6,:);
...
Ti1_intup1(:,145:152)=STL1_Pi_out(:,6,:);
...
Ti_intup1(:,153:160)=STL_Pi_out(:,7,:);
...
Ti1_intup1(:,153:160)=STL1_Pi_out(:,7,:);
...
Ti_intup1(:,161:168)=STL_Pi_out(:,8,:);
...
Ti1_intup1(:,161:168)=STL1_Pi_out(:,8,:);
...
Tr1_intup1(:,33:40)=STL1_Baltic(:,7,:);
...
Tr1_intup1(:,57:64)=STL1_Hudson(:,7,:);
...
Tr1_intup1(:,105:112)=STL1_P_out(:,1,:);
...
Tr1_intup1(:,113:120)=STL1_P_out(:,2,:);
...
Tr1_intup1(:,121:128)=STL1_P_out(:,3,:);
...
Tr1_intup1(:,129:136)=STL1_P_out(:,4,:);
...
Tr1_intup1(:,137:144)=STL1_P_out(:,5,:);
...
Tr1_intup1(:,145:152)=STL1_P_out(:,6,:);
...
Tr1_intup1(:,153:160)=STL1_P_out(:,7,:);
...
Tr1_intup1(:,161:168)=STL1_P_out(:,8,:);
...
Ts1_intup1(:,33:40)=STL1_Baltic(:,3,:);
...
Ts1_intup1(:,57:64)=STL1_Hudson(:,3,:);
...
Ti1_intup1(:,37:45)=STL1_Baltic(:,6,:);
...
Ti1_intup1(:,64:72)=STL1_Hudson(:,6,:);
...
Ti1_intup1(:,109:117)=STL1_NNAt(:,6,:);
...
Ti_intup1(:,118:126)=STL_Pi_out(:,1,:);
...
Ti1_intup1(:,118:126)=STL1_Pi_out(:,1,:);
...
Ti_intup1(:,127:135)=STL_Pi_out(:,2,:);
...
Ti1_intup1(:,127:135)=STL1_Pi_out(:,2,:);
...
Ti_intup1(:,136:144)=STL_Pi_out(:,3,:);
...
Ti1_intup1(:,136:144)=STL1_Pi_out(:,3,:);
...
Ti_intup1(:,145:153)=STL_Pi_out(:,4,:);
...
Ti1_intup1(:,145:153)=STL1_Pi_out(:,4,:);
...
Ti_intup1(:,154:162)=STL_Pi_out(:,5,:);
...
Ti1_intup1(:,154:162)=STL1_Pi_out(:,5,:);
...
Ti_intup1(:,163:171)=STL_Pi_out(:,6,:);
...
Ti1_intup1(:,163:171)=STL1_Pi_out(:,6,:);
...
Ti_intup1(:,172:180)=STL_Pi_out(:,7,:);
...
Ti1_intup1(:,172:180)=STL1_Pi_out(:,7,:);
...
Ti_intup1(:,181:189)=STL_Pi_out(:,8,:);
...
Ti1_intup1(:,181:189)=STL1_Pi_out(:,8,:);
...
Ti_intup1(:,190:198)=STL_Pi_out(:,9,:);
...
Ti1_intup1(:,190:198)=STL1_Pi_out(:,9,:);
...
Tr1_intup1(:,37:45)=STL1_Baltic(:,7,:);
...
Tr1_intup1(:,64:72)=STL1_Hudson(:,7,:);
...
Tr1_intup1(:,109:117)=STL1_NNAt(:,7,:);
...
Tr1_intup1(:,118:126)=STL1_P_out(:,1,:);
...
Tr1_intup1(:,127:135)=STL1_P_out(:,2,:);
...
Tr1_intup1(:,136:144)=STL1_P_out(:,3,:);
...
Tr1_intup1(:,145:153)=STL1_Pi_out(:,4,:);
...
Tr1_intup1(:,154:162)=STL1_P_out(:,5,:);
...
Tr1_intup1(:,163:171)=STL1_P_out(:,6,:);
...
Tr1_intup1(:,172:180)=STL1_P_out(:,7,:);
...
Tr1_intup1(:,181:189)=STL1_P_out(:,8,:);
...
Tr1_intup1(:,190:198)=STL1_P_out(:,9,:);
...
Ts1_intup1(:,37:45)=STL1_Baltic(:,3,:);
...
Ts1_intup1(:,64:72)=STL1_Hudson(:,3,:);
...
Ts1_intup1(:,109:117)=STL1_NNAt(:,3,:);
...
Ti1_intup1(:,41:50)=STL1_Baltic(:,6,:);
...
Ti1_intup1(:,71:80)=STL1_Hudson(:,6,:);
...
Ti1_intup1(:,121:130)=STL1_NNAt(:,6,:);
...
Ti_intup1(:,131:140)=STL_Pi_out(:,1,:);
...
Ti1_intup1(:,131:140)=STL1_Pi_out(:,1,:);
...
Ti_intup1(:,141:150)=STL_Pi_out(:,2,:);
...
Ti1_intup1(:,141:150)=STL1_Pi_out(:,2,:);
...
Ti_intup1(:,151:160)=STL_Pi_out(:,3,:);
...
Ti1_intup1(:,151:160)=STL1_Pi_out(:,3,:);
...
Ti_intup1(:,161:170)=STL_Pi_out(:,4,:);
...
Ti1_intup1(:,161:170)=STL1_Pi_out(:,4,:);
...
Ti_intup1(:,171:180)=STL_Pi_out(:,5,:);
...
Ti1_intup1(:,171:180)=STL1_Pi_out(:,5,:);
...
Ti_intup1(:,181:190)=STL_Pi_out(:,6,:);
...
Ti1_intup1(:,181:190)=STL1_Pi_out(:,6,:);
...
Ti_intup1(:,191:200)=STL_Pi_out(:,7,:);
...
Ti1_intup1(:,191:200)=STL1_Pi_out(:,7,:);
...
Ti_intup1(:,201:210)=STL_Pi_out(:,8,:);
...
Ti1_intup1(:,201:210)=STL1_Pi_out(:,8,:);
...
Ti_intup1(:,211:220)=STL_Pi_out(:,9,:);
...
Ti1_intup1(:,211:220)=STL1_Pi_out(:,9,:);
...
Ti_intup1(:,221:230)=STL_Pi_out(:,10,:);
...
Ti1_intup1(:,221:230)=STL1_Pi_out(:,10,:);
...
Tr1_intup1(:,41:50)=STL1_Baltic(:,7,:);
...
Tr1_intup1(:,71:80)=STL1_Hudson(:,7,:);
...
Tr1_intup1(:,121:130)=STL1_NNAt(:,7,:);
...
Tr1_intup1(:,131:140)=STL1_P_out(:,1,:);
...
Tr1_intup1(:,141:150)=STL1_P_out(:,2,:);
...
Tr1_intup1(:,151:160)=STL1_P_out(:,3,:);
...
Tr1_intup1(:,161:170)=STL1_P_out(:,4,:);
...
Tr1_intup1(:,171:180)=STL1_P_out(:,5,:);
...
Tr1_intup1(:,181:190)=STL1_P_out(:,6,:);
...
Tr1_intup1(:,191:200)=STL1_P_out(:,7,:);
...
Tr1_intup1(:,201:210)=STL1_P_out(:,8,:);
...
Tr1_intup1(:,211:220)=STL1_P_out(:,9,:);
...
Tr_intup1(:,221:230)=STL_P_out(:,10,:);
...
Tr1_intup1(:,221:230)=STL1_P_out(:,10,:);
...
Ts1_intup1(:,41:50)=STL1_Baltic(:,3,:);
...
Ts1_intup1(:,71:80)=STL1_Hudson(:,3,:);
...
Ts1_intup1(:,121:130)=STL1_NNAt(:,3,:);
...
for i=1:mode
    for j=1:ir
    RR=corrcoef(STL_TWS(:,6,i),Ti_intup1(7:189,j));
    Ri_input1(j,i)=RR(1,2);
    RR=corrcoef(STL1_TWS(:,6,i),Ti1_intup1(7:189,j));
...
for i=1:mode
    for j=1:ir
    RR=corrcoef(STL_TWS(:,7,i),Tr_intup1(7:189,j));
    Rr_input1(j,i)=RR(1,2);
    RR=corrcoef(STL1_TWS(:,7,i),Tr1_intup1(7:189,j));
...
for i=1:mode
    for j=1:ss
    RR=corrcoef(STL_TWS(:,3,i),Ts_intup1(7:189,j));
    Rs_input1(j,i)=RR(1,2);
    RR=corrcoef(STL1_TWS(:,3,i),Ts1_intup1(7:189,j));
...
% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tot=183;       %number of the GRACE time series
%------------------Identify the time lag of inter annual-------------------
for i=1:mode
    for j=1:ir
        Rii(j,i)=0;
        Rii1(j,i)=0;
for m=-3:3;    %search for the best time lag from -3 to 3
    RR=corrcoef(STL_TWS(:,6,i),Ti_input(7+m:189+m,j,i));
    if (abs(Rii(j,i))<abs(RR(1,2)))
        Rii(j,i)=RR(1,2);
        TDi(j,i)=m;
    end
    RR=corrcoef(STL1_TWS(:,6,i),Ti1_input(7+m:189+m,j,i));
...
%--------------rank the inter annual after adjusting the time lags---------
for i=1:mode
    [U K]=sort(abs(Rii(:,i)));
...
%------------------Identify the time lag of seasonal-----------------------
for i=1:mode
    for j=1:ss
        Rss(j,i)=0;
        Rss1(j,i)=0;
for m=-3:3;    %search for the best time lag from -3 to 3
    RR=corrcoef(STL_TWS(:,3,i),Ts_input(7+m:189+m,j,i));
    if (abs(Rss(j,i))<abs(RR(1,2)))
        Rss(j,i)=RR(1,2);
        TDs(j,i)=m;
    end
    RR=corrcoef(STL1_TWS(:,3,i),Ts1_input(7+m:189+m,j,i));
...
%--------------rank the seasonal after adjusting the time lags-------------
for i=1:mode
    [U K]=sort(abs(Rss(:,i)));
...
%------------------Identify the time lag of residual-----------------------
for i=1:mode
    for j=1:ir
        Rrr(j,i)=0;
        Rrr1(j,i)=0;
for m=-3:3;    %search for the best time lag from -3 to 3
    RR=corrcoef(STL_TWS(:,7,i),Tr_input(7+m:189+m,j,i));
    if (abs(Rrr(j,i))<abs(RR(1,2)))
        Rrr(j,i)=RR(1,2);
        TDr(j,i)=m;
    end
    RR=corrcoef(STL1_TWS(:,7,i),Tr1_input(7+m:189+m,j,i));
...
%--------------rank the residual after adjusting the time lags-------------
for i=1:mode
    [U K]=sort(abs(Rrr(:,i)));
...
for i=1:mode
    Ys(:,1,i)=STL_TWS(:,3,i);
    Ys1(:,1,i)=STL1_TWS(:,3,i);
    Xs(:,1,i)=Ts_in(7+TDs_in(1,i):189+TDs_in(1,i),1,i);
    Xs(:,2,i)=Ts_in(7+TDs_in(2,i):189+TDs_in(2,i),2,i);
    Xs(:,3,i)=Ts_in(7+TDs_in(3,i):189+TDs_in(3,i),3,i);
    Xs(:,4,i)=Ts_in(7+TDs_in(4,i):189+TDs_in(4,i),4,i);
    Xs(:,5,i)=Ts_in(7+TDs_in(5,i):189+TDs_in(5,i),5,i);
    Xs(:,6,i)=Ts_in(7+TDs_in(6,i):189+TDs_in(6,i),6,i);
    Xs(:,7,i)=Ts_in(7+TDs_in(7,i):189+TDs_in(7,i),7,i);
    Xs(:,8,i)=Ts_in(7+TDs_in(8,i):189+TDs_in(8,i),8,i);
    Xs(:,9,i)=Ts_in(7+TDs_in(9,i):189+TDs_in(9,i),9,i);
    Xs(:,10,i)=Ts_in(7+TDs_in(10,i):189+TDs_in(10,i),10,i);
    Xs1(:,1,i)=Ts1_in(7+TDs1_in(1,i):189+TDs1_in(1,i),1,i);
    Xs1(:,2,i)=Ts1_in(7+TDs1_in(2,i):189+TDs1_in(2,i),2,i);
    Xs1(:,3,i)=Ts1_in(7+TDs1_in(3,i):189+TDs1_in(3,i),3,i);
    Xs1(:,4,i)=Ts1_in(7+TDs1_in(4,i):189+TDs1_in(4,i),4,i);
    Xs1(:,5,i)=Ts1_in(7+TDs1_in(5,i):189+TDs1_in(5,i),5,i);
    Xs1(:,6,i)=Ts1_in(7+TDs1_in(6,i):189+TDs1_in(6,i),6,i);
    Xs1(:,7,i)=Ts1_in(7+TDs1_in(7,i):189+TDs1_in(7,i),7,i);
    Xs1(:,8,i)=Ts1_in(7+TDs1_in(8,i):189+TDs1_in(8,i),8,i);
    Xs1(:,9,i)=Ts1_in(7+TDs1_in(9,i):189+TDs1_in(9,i),9,i);
    Xs1(:,10,i)=Ts1_in(7+TDs1_in(10,i):189+TDs1_in(10,i),10,i);
end
% % % %**************************************************************************
for i=1:mode
    Yi(:,1,i)=STL_TWS(:,6,i);
    Yi1(:,1,i)=STL1_TWS(:,6,i);
    Xi(:,1,i)=Ti_in(7+TDi_in(1,i):189+TDi_in(1,i),1,i);
    Xi(:,2,i)=Ti_in(7+TDi_in(2,i):189+TDi_in(2,i),2,i);
    Xi(:,3,i)=Ti_in(7+TDi_in(3,i):189+TDi_in(3,i),3,i);
    Xi(:,4,i)=Ti_in(7+TDi_in(4,i):189+TDi_in(4,i),4,i);
    Xi(:,5,i)=Ti_in(7+TDi_in(5,i):189+TDi_in(5,i),5,i);
    Xi(:,6,i)=Ti_in(7+TDi_in(6,i):189+TDi_in(6,i),6,i);
    Xi(:,7,i)=Ti_in(7+TDi_in(7,i):189+TDi_in(7,i),7,i);
    Xi(:,8,i)=Ti_in(7+TDi_in(8,i):189+TDi_in(8,i),8,i);
    Xi(:,9,i)=Ti_in(7+TDi_in(9,i):189+TDi_in(9,i),9,i);
    Xi(:,10,i)=Ti_in(7+TDi_in(10,i):189+TDi_in(10,i),10,i);
    Xi1(:,1,i)=Ti1_in(7+TDi1_in(1,i):189+TDi1_in(1,i),1,i);
    Xi1(:,2,i)=Ti1_in(7+TDi1_in(2,i):189+TDi1_in(2,i),2,i);
    Xi1(:,3,i)=Ti1_in(7+TDi1_in(3,i):189+TDi1_in(3,i),3,i);
    Xi1(:,4,i)=Ti1_in(7+TDi1_in(4,i):189+TDi1_in(4,i),4,i);
    Xi1(:,5,i)=Ti1_in(7+TDi1_in(5,i):189+TDi1_in(5,i),5,i);
    Xi1(:,6,i)=Ti1_in(7+TDi1_in(6,i):189+TDi1_in(6,i),6,i);
    Xi1(:,7,i)=Ti1_in(7+TDi1_in(7,i):189+TDi1_in(7,i),7,i);
    Xi1(:,8,i)=Ti1_in(7+TDi1_in(8,i):189+TDi1_in(8,i),8,i);
    Xi1(:,9,i)=Ti1_in(7+TDi1_in(9,i):189+TDi1_in(9,i),9,i);
    Xi1(:,10,i)=Ti1_in(7+TDi1_in(10,i):189+TDi1_in(10,i),10,i);
end
% % %**************************************************************************
% 
for i=1:mode
    Yr(:,1,i)=STL_TWS(:,7,i);
    Yr1(:,1,i)=STL1_TWS(:,7,i);
    Xr(:,1,i)=Tr_in(7+TDr_in(1,i):189+TDr_in(1,i),1,i);
    Xr(:,2,i)=Tr_in(7+TDr_in(2,i):189+TDr_in(2,i),2,i);
    Xr(:,3,i)=Tr_in(7+TDr_in(3,i):189+TDr_in(3,i),3,i);
    Xr(:,4,i)=Tr_in(7+TDr_in(4,i):189+TDr_in(4,i),4,i);
    Xr(:,5,i)=Tr_in(7+TDr_in(5,i):189+TDr_in(5,i),5,i);
    Xr(:,6,i)=Tr_in(7+TDr_in(6,i):189+TDr_in(6,i),6,i);
    Xr(:,7,i)=Tr_in(7+TDr_in(7,i):189+TDr_in(7,i),7,i);
    Xr(:,8,i)=Tr_in(7+TDr_in(8,i):189+TDr_in(8,i),8,i);
    Xr(:,9,i)=Tr_in(7+TDr_in(9,i):189+TDr_in(9,i),9,i);
    Xr(:,10,i)=Tr_in(7+TDr_in(10,i):189+TDr_in(10,i),10,i);
    Xr1(:,1,i)=Tr1_in(7+TDr1_in(1,i):189+TDr1_in(1,i),1,i);
    Xr1(:,2,i)=Tr1_in(7+TDr1_in(2,i):189+TDr1_in(2,i),2,i);
    Xr1(:,3,i)=Tr1_in(7+TDr1_in(3,i):189+TDr1_in(3,i),3,i);
    Xr1(:,4,i)=Tr1_in(7+TDr1_in(4,i):189+TDr1_in(4,i),4,i);
    Xr1(:,5,i)=Tr1_in(7+TDr1_in(5,i):189+TDr1_in(5,i),5,i);
    Xr1(:,6,i)=Tr1_in(7+TDr1_in(6,i):189+TDr1_in(6,i),6,i);
    Xr1(:,7,i)=Tr1_in(7+TDr1_in(7,i):189+TDr1_in(7,i),7,i);
    Xr1(:,8,i)=Tr1_in(7+TDr1_in(8,i):189+TDr1_in(8,i),8,i);
    Xr1(:,9,i)=Tr1_in(7+TDr1_in(9,i):189+TDr1_in(9,i),9,i);
    Xr1(:,10,i)=Tr1_in(7+TDr1_in(10,i):189+TDr1_in(10,i),10,i);
end
%% % %% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % setting model parameters 
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Orders (1)=3;%order-1 of ARX model
Orders (2)=3;%order-2 of ARX model
%---------------------time lag---------------------------------------------
for i=10
    for j=mode
      kqi(i,j)=0;
...
% % %%%%%%%%%%%%
N=5;                 % number of hidden layer of the ANN model
n=1;                 % times of repetition of ANN processes
%%%%%%%%%%%%%%%%
L1=96;               % longth of the train section
L2=72;               % longth of the predicting section
ts=L1+L2;            % ts<=tot
nn=1;                % time section moving steps
inte=1;              % time section moving interval
mm=L1+nn*inte;
for i=1:nn
    Cut(i)=mm-i*inte;
end
%
%% % %% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % Run the ARX, ANN, and MLR models
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for k=1:nn
    k
    for i=1:mode
    %ARX-ICA
    [Param,Calib,ARXResi,ARXRMS,ARXPredi(:,i),ARXPreResi,ARXPreRMS] = ARX_TEST(Xi(:,1:3,i),Yi(:,:,i),Orders,kqi(:,i),Cut(k),L1,L2);
    [Param,Calib,ARXResi,ARXRMS,ARXPredr(:,i),ARXPreResi,ARXPreRMS] = ARX_TEST(Xr(:,1:3,i),Yr(:,:,i),Orders,kqr(:,i),Cut(k),L1,L2);
    [Param,Calib,ARXResi,ARXRMS,ARXPreds(:,i),ARXPreResi,ARXPreRMS] = ARX_TEST(Xs(:,1:3,i),Ys(:,:,i),Orders,kqs(:,i),Cut(k),L1,L2);
    %MLR-ICA
    [ALRPredi(:,i)] = multi_regress(Yi(:,:,i),Xi(:,1:3,i),Cut(k),L1,L2);
    [ALRPredr(:,i)] = multi_regress(Yr(:,:,i),Xr(:,1:3,i),Cut(k),L1,L2);
    [ALRPreds(:,i)] = multi_regress(Ys(:,:,i),Xs(:,1:5,i),Cut(k),L1,L2);
    %ARX-PCA
    [Param,Calib,ARXResi,ARXRMS,ARXPredi1(:,i),ARXPreResi,ARXPreRMS] = ARX_TEST(Xi1(:,1:3,i),Yi1(:,:,i),Orders,kqi1(:,i),Cut(k),L1,L2);
    [Param,Calib,ARXResi,ARXRMS,ARXPredr1(:,i),ARXPreResi,ARXPreRMS] = ARX_TEST(Xr1(:,1:3,i),Yr1(:,:,i),Orders,kqr1(:,i),Cut(k),L1,L2);
    [Param,Calib,ARXResi,ARXRMS,ARXPreds1(:,i),ARXPreResi,ARXPreRMS] = ARX_TEST(Xs1(:,1:3,i),Ys1(:,:,i),Orders,kqs1(:,i),Cut(k),L1,L2);
    %MLR-PCA
    [ALRPredi1(:,i)] = multi_regress(Yi1(:,:,i),Xi1(:,1:3,i),Cut(k),L1,L2);
    [ALRPredr1(:,i)] = multi_regress(Yr1(:,:,i),Xr1(:,1:3,i),Cut(k),L1,L2);
    [ALRPreds1(:,i)] = multi_regress(Ys1(:,:,i),Xs1(:,1:3,i),Cut(k),L1,L2);
    end
for i=1:n     %repeat the ANN process
        i
for j=1:mode
%ANN-ICA
[ANNPred]=ANN_TEST(Xi(:,1:3,j),Yi(:,:,j),N,Cut(k),L1,L2);
ANNPred1i(:,i,j,k)=ANNPred;
[ANNPred]=ANN_TEST(Xr(:,1:3,j),Yr(:,:,j),N,Cut(k),L1,L2);
ANNPred1r(:,i,j,k)=ANNPred;
[ANNPred]=ANN_TEST(Xs(:,1:3,j),Ys(:,:,j),N,Cut(k),L1,L2);
ANNPred1s(:,i,j,k)=ANNPred;
%ANN-PCA
[ANNPred]=ANN_TEST(Xi1(:,1:3,j),Yi1(:,:,j),N,Cut(k),L1,L2);
ANNPred1i1(:,i,j,k)=ANNPred;
[ANNPred]=ANN_TEST(Xr1(:,1:3,j),Yr1(:,:,j),N,Cut(k),L1,L2);
ANNPred1r1(:,i,j,k)=ANNPred;
[ANNPred]=ANN_TEST(Xs1(:,1:3,j),Ys1(:,:,j),N,Cut(k),L1,L2);
ANNPred1s1(:,i,j,k)=ANNPred;
end
end
for i=1:mode
      
    for j=1:ts           %averaging            
      ANNPred_Ti(j,i,k)=sum(ANNPred1i(j,1:n,i,k))/n;
      ANNPred_Tr(j,i,k)=sum(ANNPred1r(j,1:n,i,k))/n;
      ANNPred_Ts(j,i,k)=sum(ANNPred1s(j,1:n,i,k))/n;
      %
      ANNPred_Ti1(j,i,k)=sum(ANNPred1i1(j,1:n,i,k))/n;
      ANNPred_Tr1(j,i,k)=sum(ANNPred1r1(j,1:n,i,k))/n;
      ANNPred_Ts1(j,i,k)=sum(ANNPred1s1(j,1:n,i,k))/n;
    end
  %-----------------------prediction uncertainties of IC temporal mode components-----------------
      ANNPre_RMS_Ti(k,i)      =    rms(Yi(Cut(k)+1:Cut(k)+L2,1,i)-ANNPred_Ti(L1+1:ts,i,k));
      ARXPre_RMS_Ti(k,i)      =    rms(Yi(Cut(k)+1:Cut(k)+L2,1,i)-ARXPredi(L1+1:ts,i));
      ALRPre_RMS_Ti(k,i)      =    rms(Yi(Cut(k)+1:Cut(k)+L2,1,i)-ALRPredi(L1+1:ts,i));
      ANNPre_RMS_Tr(k,i)      =    rms(Yr(Cut(k)+1:Cut(k)+L2,1,i)-ANNPred_Tr(L1+1:ts,i,k));
      ARXPre_RMS_Tr(k,i)      =    rms(Yr(Cut(k)+1:Cut(k)+L2,1,i)-ARXPredr(L1+1:ts,i));
      ALRPre_RMS_Tr(k,i)      =    rms(Yr(Cut(k)+1:Cut(k)+L2,1,i)-ALRPredr(L1+1:ts,i));
      ANNPre_RMS_Ts(k,i)      =    rms(Ys(Cut(k)+1:Cut(k)+L2,1,i)-ANNPred_Ts(L1+1:ts,i,k));
      ARXPre_RMS_Ts(k,i)      =    rms(Ys(Cut(k)+1:Cut(k)+L2,1,i)-ARXPreds(L1+1:ts,i));
      ALRPre_RMS_Ts(k,i)      =    rms(Ys(Cut(k)+1:Cut(k)+L2,1,i)-ALRPreds(L1+1:ts,i));
 %------------------------simulation uncertainties of IC temporal mode components------------------
      ValANN_RMS_Ti(k,i)      =    rms(Yi(Cut(k)-L1+1:Cut(k),1,i)-ANNPred_Ti(1:L1,i,k));
      ValARX_RMS_Ti(k,i)      =    rms(Yi(Cut(k)-L1+1:Cut(k),1,i)-ARXPredi(1:L1,i));
      ValALR_RMS_Ti(k,i)      =    rms(Yi(Cut(k)-L1+1:Cut(k),1,i)-ALRPredi(1:L1,i));
      ValANN_RMS_Tr(k,i)      =    rms(Yr(Cut(k)-L1+1:Cut(k),1,i)-ANNPred_Tr(1:L1,i,k));
      ValARX_RMS_Tr(k,i)      =    rms(Yr(Cut(k)-L1+1:Cut(k),1,i)-ARXPredr(1:L1,i));
      ValALR_RMS_Tr(k,i)      =    rms(Yr(Cut(k)-L1+1:Cut(k),1,i)-ALRPredr(1:L1,i));
      ValANN_RMS_Ts(k,i)      =    rms(Ys(Cut(k)-L1+1:Cut(k),1,i)-ANNPred_Ts(1:L1,i,k));
      ValARX_RMS_Ts(k,i)      =    rms(Ys(Cut(k)-L1+1:Cut(k),1,i)-ARXPreds(1:L1,i));
      ValALR_RMS_Ts(k,i)      =    rms(Ys(Cut(k)-L1+1:Cut(k),1,i)-ALRPreds(1:L1,i));
%-------------------------reconstruction of IC temporal modes----------------------------------
      ANN_T(:,i,k)              =    ANNPred_Ti(:,i,k)+ANNPred_Tr(:,i,k)+ANNPred_Ts(:,i,k);
      ARX_T(:,i,k)              =    ARXPredi(:,i)+ARXPredr(:,i)+ARXPreds(:,i);
      ALR_T(:,i,k)              =    ALRPredi(:,i)+ALRPredr(:,i)+ALRPreds(:,i);
      TWS_T(:,i,k)              =    Yi(Cut(k)-L1+1:Cut(k)+L2,1,i)+Yr(Cut(k)-L1+1:Cut(k)+L2,1,i)+Ys(Cut(k)-L1+1:Cut(k)+L2,1,i);
%-------------------------prediction uncertainties of EOF temporal mode components-----------------
      ANNPre_RMS_Ti1(k,i)      =    rms(Yi1(Cut(k)+1:Cut(k)+L2,1,i)-ANNPred_Ti1(L1+1:ts,i,k));
      ARXPre_RMS_Ti1(k,i)      =    rms(Yi1(Cut(k)+1:Cut(k)+L2,1,i)-ARXPredi1(L1+1:ts,i));
      ALRPre_RMS_Ti1(k,i)      =    rms(Yi1(Cut(k)+1:Cut(k)+L2,1,i)-ALRPredi1(L1+1:ts,i));
      ANNPre_RMS_Tr1(k,i)      =    rms(Yr1(Cut(k)+1:Cut(k)+L2,1,i)-ANNPred_Tr1(L1+1:ts,i,k));
      ARXPre_RMS_Tr1(k,i)      =    rms(Yr1(Cut(k)+1:Cut(k)+L2,1,i)-ARXPredr1(L1+1:ts,i));
      ALRPre_RMS_Tr1(k,i)      =    rms(Yr1(Cut(k)+1:Cut(k)+L2,1,i)-ALRPredr1(L1+1:ts,i));
      ANNPre_RMS_Ts1(k,i)      =    rms(Ys1(Cut(k)+1:Cut(k)+L2,1,i)-ANNPred_Ts1(L1+1:ts,i,k));
      ARXPre_RMS_Ts1(k,i)      =    rms(Ys1(Cut(k)+1:Cut(k)+L2,1,i)-ARXPreds1(L1+1:ts,i));
      ALRPre_RMS_Ts1(k,i)      =    rms(Ys1(Cut(k)+1:Cut(k)+L2,1,i)-ALRPreds1(L1+1:ts,i));
      ValANN_RMS_Ti1(k,i)      =    rms(Yi1(Cut(k)-L1+1:Cut(k),1,i)-ANNPred_Ti1(1:L1,i,k));
 %------------------------simulation uncertainties of EOF temporal mode components------------------
      ValARX_RMS_Ti1(k,i)      =    rms(Yi1(Cut(k)-L1+1:Cut(k),1,i)-ARXPredi1(1:L1,i));
      ValALR_RMS_Ti1(k,i)      =    rms(Yi1(Cut(k)-L1+1:Cut(k),1,i)-ALRPredi1(1:L1,i));
      ValANN_RMS_Tr1(k,i)      =    rms(Yr1(Cut(k)-L1+1:Cut(k),1,i)-ANNPred_Tr1(1:L1,i,k));
      ValARX_RMS_Tr1(k,i)      =    rms(Yr1(Cut(k)-L1+1:Cut(k),1,i)-ARXPredr1(1:L1,i));
      ValALR_RMS_Tr1(k,i)      =    rms(Yr1(Cut(k)-L1+1:Cut(k),1,i)-ALRPredr1(1:L1,i));
      ValANN_RMS_Ts1(k,i)      =    rms(Ys1(Cut(k)-L1+1:Cut(k),1,i)-ANNPred_Ts1(1:L1,i,k));
      ValARX_RMS_Ts1(k,i)      =    rms(Ys1(Cut(k)-L1+1:Cut(k),1,i)-ARXPreds1(1:L1,i));
      ValALR_RMS_Ts1(k,i)      =    rms(Ys1(Cut(k)-L1+1:Cut(k),1,i)-ALRPreds1(1:L1,i));
%-------------------------reconstruction of EOF temporal modes----------------------------------     
      ANN_T1(:,i,k)              =    ANNPred_Ti1(:,i,k)+ANNPred_Tr1(:,i,k)+ANNPred_Ts1(:,i,k);
      ARX_T1(:,i,k)              =    ARXPredi1(:,i)+ARXPredr1(:,i)+ARXPreds1(:,i);
      ALR_T1(:,i,k)              =    ALRPredi1(:,i)+ALRPredr1(:,i)+ALRPreds1(:,i);
      TWS_T1(:,i,k)              =    Yi1(Cut(k)-L1+1:Cut(k)+L2,1,i)+Yr1(Cut(k)-L1+1:Cut(k)+L2,1,i)+Ys1(Cut(k)-L1+1:Cut(k)+L2,1,i);
% %       
end

%% %%%%*******************Gridded TWSC from ICA method***************************
%
%-----------------------reconstruction of TWSC----------------------------------
a1_TWS_ANNPRE(:,1:ts,k)=S_TWS(:,:)*ANN_T(1:ts,:,k)';
a1_TWS_ARXPRE(:,1:ts,k)=S_TWS(:,:)*ARX_T(1:ts,:,k)';
a1_TWS_ALRPRE(:,1:ts,k)=S_TWS(:,:)*ALR_T(1:ts,:,k)';
a1_TWS_Delinear(:,:,k)=S_TWS(:,:)*TWS_T(:,:,k)';

%------------------prediction and simulation errors of TWSC at the grid scale--------------------
for i=1:p
ARXT_RMS_ALL(i,k)=rms(a1_TWS(i,Cut(k)+1:Cut(k)+L2)-a1_TWS_ARXPRE(i,L1+1:ts,k));%prediction
ANNT_RMS_ALL(i,k)=rms(a1_TWS(i,Cut(k)+1:Cut(k)+L2)-a1_TWS_ANNPRE(i,L1+1:ts,k));%prediction
ALRT_RMS_ALL(i,k)=rms(a1_TWS(i,Cut(k)+1:Cut(k)+L2)-a1_TWS_ALRPRE(i,L1+1:ts,k));%prediction
ValARXT_RMS_ALL(i,k)=rms(a1_TWS(i,Cut(k)-L1+1:Cut(k))-a1_TWS_ARXPRE(i,1:L1,k));%simulation
ValANNT_RMS_ALL(i,k)=rms(a1_TWS(i,Cut(k)-L1+1:Cut(k))-a1_TWS_ANNPRE(i,1:L1,k));%simulation
ValALRT_RMS_ALL(i,k)=rms(a1_TWS(i,Cut(k)-L1+1:Cut(k))-a1_TWS_ALRPRE(i,1:L1,k));%simulation
ARX_RMS_ALL(i,k)=rms(a1_TWS_Delinear(i,L1+1:ts,k)-a1_TWS_ARXPRE(i,L1+1:ts,k)); %prediction
ANN_RMS_ALL(i,k)=rms(a1_TWS_Delinear(i,L1+1:ts,k)-a1_TWS_ANNPRE(i,L1+1:ts,k)); %prediction
ALR_RMS_ALL(i,k)=rms(a1_TWS_Delinear(i,L1+1:ts,k)-a1_TWS_ALRPRE(i,L1+1:ts,k)); %prediction
ValARX_RMS_ALL(i,k)=rms(a1_TWS_Delinear(i,1:L1,k)-a1_TWS_ARXPRE(i,1:L1,k));    %simulation
ValANN_RMS_ALL(i,k)=rms(a1_TWS_Delinear(i,1:L1,k)-a1_TWS_ANNPRE(i,1:L1,k));    %simulation
ValALR_RMS_ALL(i,k)=rms(a1_TWS_Delinear(i,1:L1,k)-a1_TWS_ALRPRE(i,1:L1,k));    %simulation

%------correlation coefficients of predicted and simulated TWSC at the grid scale--------------------
RR=corrcoef(a1_TWS(i,Cut(k)+1:Cut(k)+L2),a1_TWS_ARXPRE(i,L1+1:ts,k));
ARX_R_ALL(i,k)=RR(1,2);
RR=corrcoef(a1_TWS(i,Cut(k)+1:Cut(k)+L2),a1_TWS_ANNPRE(i,L1+1:ts,k));
ANN_R_ALL(i,k)=RR(1,2);
RR=corrcoef(a1_TWS(i,Cut(k)+1:Cut(k)+L2),a1_TWS_ALRPRE(i,L1+1:ts,k));
ALR_R_ALL(i,k)=RR(1,2);
end

%% %%%%*******************Gridded TWSC from PCA method***************************
%
%-----------------------reconstruction of TWSC----------------------------------
a1_TWS_ANNPRE1(:,1:ts,k)=S1_TWS(:,:)*ANN_T1(1:ts,:,k)';
a1_TWS_ARXPRE1(:,1:ts,k)=S1_TWS(:,:)*ARX_T1(1:ts,:,k)';
a1_TWS_ALRPRE1(:,1:ts,k)=S1_TWS(:,:)*ALR_T1(1:ts,:,k)';
a1_TWS_Delinear1(:,:,k)=S1_TWS(:,:)*TWS_T1(:,:,k)';

%------------------prediction and simulation errors of TWSC in each moving section--------------------
for i=1:p
ARXT_RMS_ALL1(i,k)=rms(a1_TWS(i,Cut(k)+1:Cut(k)+L2)-a1_TWS_ARXPRE1(i,L1+1:ts,k));%prediction
ANNT_RMS_ALL1(i,k)=rms(a1_TWS(i,Cut(k)+1:Cut(k)+L2)-a1_TWS_ANNPRE1(i,L1+1:ts,k));%prediction
ALRT_RMS_ALL1(i,k)=rms(a1_TWS(i,Cut(k)+1:Cut(k)+L2)-a1_TWS_ALRPRE1(i,L1+1:ts,k));%prediction
ValARXT_RMS_ALL1(i,k)=rms(a1_TWS(i,Cut(k)-L1+1:Cut(k))-a1_TWS_ARXPRE1(i,1:L1,k));%simulation
ValANNT_RMS_ALL1(i,k)=rms(a1_TWS(i,Cut(k)-L1+1:Cut(k))-a1_TWS_ANNPRE1(i,1:L1,k));%simulation
ValALRT_RMS_ALL1(i,k)=rms(a1_TWS(i,Cut(k)-L1+1:Cut(k))-a1_TWS_ALRPRE1(i,1:L1,k));%simulation
ARX_RMS_ALL1(i,k)=rms(a1_TWS_Delinear1(i,L1+1:ts,k)-a1_TWS_ARXPRE1(i,L1+1:ts,k));%prediction
ANN_RMS_ALL1(i,k)=rms(a1_TWS_Delinear1(i,L1+1:ts,k)-a1_TWS_ANNPRE1(i,L1+1:ts,k));%prediction
ALR_RMS_ALL1(i,k)=rms(a1_TWS_Delinear1(i,L1+1:ts,k)-a1_TWS_ALRPRE1(i,L1+1:ts,k));%prediction
ValARX_RMS_ALL1(i,k)=rms(a1_TWS_Delinear1(i,1:L1,k)-a1_TWS_ARXPRE1(i,1:L1,k));   %simulation
ValANN_RMS_ALL1(i,k)=rms(a1_TWS_Delinear1(i,1:L1,k)-a1_TWS_ANNPRE1(i,1:L1,k));   %simulation
ValALR_RMS_ALL1(i,k)=rms(a1_TWS_Delinear1(i,1:L1,k)-a1_TWS_ALRPRE1(i,1:L1,k));   %simulation

%------correlation coefficients of predicted and simulated TWSC in each moving section---------------------
RR=corrcoef(a1_TWS(i,Cut(k)+1:Cut(k)+L2),a1_TWS_ARXPRE1(i,L1+1:ts,k));
ARX_R_ALL1(i,k)=RR(1,2);
RR=corrcoef(a1_TWS(i,Cut(k)+1:Cut(k)+L2),a1_TWS_ANNPRE1(i,L1+1:ts,k));
ANN_R_ALL1(i,k)=RR(1,2);
RR=corrcoef(a1_TWS(i,Cut(k)+1:Cut(k)+L2),a1_TWS_ALRPRE1(i,L1+1:ts,k));
ALR_R_ALL1(i,k)=RR(1,2);
end

%% %%%%*******************Basin-mean TWSC from ICA/PCA methods***************************

%----------------------averaging gridded TWSC in a specific region---------
for i=1:ts
S(i,k)=sum(a1_TWS(:,Cut(k)-L1+i))/p;
S_TWS_ANNPRE(i,k)=sum(a1_TWS_ANNPRE(:,i,k))/p;
S_TWS_ARXPRE(i,k)=sum(a1_TWS_ARXPRE(:,i,k))/p;
S_TWS_ALRPRE(i,k)=sum(a1_TWS_ALRPRE(:,i,k))/p;
% %
S1(i,k)=sum(a1_TWS(:,Cut(k)-L1+i))/p;
S1_TWS_ANNPRE(i,k)=sum(a1_TWS_ANNPRE1(:,i,k))/p;
S1_TWS_ARXPRE(i,k)=sum(a1_TWS_ARXPRE1(:,i,k))/p;
S1_TWS_ALRPRE(i,k)=sum(a1_TWS_ALRPRE1(:,i,k))/p;
end
%-------prediction and simulation errors of basin-mean TWSC in a specific region---------
      ANNPre_TWS_RMS(k,1)      =    rms(S(L1+1:ts,k)-S_TWS_ANNPRE(L1+1:ts,k));   %prediction
      ARXPre_TWS_RMS(k,1)      =    rms(S(L1+1:ts,k)-S_TWS_ARXPRE(L1+1:ts,k));   %prediction
      ALRPre_TWS_RMS(k,1)      =    rms(S(L1+1:ts,k)-S_TWS_ALRPRE(L1+1:ts,k));   %prediction
      ValANNPre_TWS_RMS(k,1)      =    rms(S(1:L1,k)-S_TWS_ANNPRE(1:L1,k));      %simulation
      ValARXPre_TWS_RMS(k,1)      =    rms(S(1:L1,k)-S_TWS_ARXPRE(1:L1,k));      %simulation
      ValALRPre_TWS_RMS(k,1)      =    rms(S(1:L1,k)-S_TWS_ALRPRE(1:L1,k));      %simulation
      ANNPre_TWS_RMS1(k,1)      =    rms(S1(L1+1:ts,k)-S1_TWS_ANNPRE(L1+1:ts,k));%prediction
      ARXPre_TWS_RMS1(k,1)      =    rms(S1(L1+1:ts,k)-S1_TWS_ARXPRE(L1+1:ts,k));%prediction
      ALRPre_TWS_RMS1(k,1)      =    rms(S1(L1+1:ts,k)-S1_TWS_ALRPRE(L1+1:ts,k));%prediction
      ValANNPre_TWS_RMS1(k,1)      =    rms(S1(1:L1,k)-S1_TWS_ANNPRE(1:L1,k));   %simulation
      ValARXPre_TWS_RMS1(k,1)      =    rms(S1(1:L1,k)-S1_TWS_ARXPRE(1:L1,k));   %simulation
      ValALRPre_TWS_RMS1(k,1)      =    rms(S1(1:L1,k)-S1_TWS_ALRPRE(1:L1,k));   %simulation
      
end
%% *****************error estimation of gridded TWSC*********************************************

%-------------------errors of predicted and simulated TWSC at the grid scale-------------------
for i=1:p
ARXT_RMS_AVE(i,1)=sum(ARXT_RMS_ALL(i,1:k))/k;        %prediction
ANNT_RMS_AVE(i,1)=sum(ANNT_RMS_ALL(i,1:k))/k;        %prediction
ALRT_RMS_AVE(i,1)=sum(ALRT_RMS_ALL(i,1:k))/k;        %prediction
ARXT_RMS_AVE1(i,1)=sum(ARXT_RMS_ALL1(i,1:k))/k;      %prediction
ANNT_RMS_AVE1(i,1)=sum(ANNT_RMS_ALL1(i,1:k))/k;      %prediction
ALRT_RMS_AVE1(i,1)=sum(ALRT_RMS_ALL1(i,1:k))/k;      %prediction
ValARXT_RMS_AVE(i,1)=sum(ValARXT_RMS_ALL(i,1:k))/k;  %simulation
ValANNT_RMS_AVE(i,1)=sum(ValANNT_RMS_ALL(i,1:k))/k;  %simulation
ValALRT_RMS_AVE(i,1)=sum(ValALRT_RMS_ALL(i,1:k))/k;  %simulation
ValARXT_RMS_AVE1(i,1)=sum(ValARXT_RMS_ALL1(i,1:k))/k;%simulation
ValANNT_RMS_AVE1(i,1)=sum(ValANNT_RMS_ALL1(i,1:k))/k;%simulation
ValALRT_RMS_AVE1(i,1)=sum(ValALRT_RMS_ALL1(i,1:k))/k;%simulation
% ------------correlation coefficients of predicted TWSC at the grid scale---------------
ARX_R_AVE(i,1)=sum(ARX_R_ALL(i,1:k))/k;  %prediction
ANN_R_AVE(i,1)=sum(ANN_R_ALL(i,1:k))/k;  %prediction
ALR_R_AVE(i,1)=sum(ALR_R_ALL(i,1:k))/k;  %prediction
ARX_R_AVE1(i,1)=sum(ARX_R_ALL1(i,1:k))/k;%prediction
ANN_R_AVE1(i,1)=sum(ANN_R_ALL1(i,1:k))/k;%prediction
ALR_R_AVE1(i,1)=sum(ALR_R_ALL1(i,1:k))/k;%prediction
end
%-------------------averaged errors of the gridded TWSC in a specific region-------------------
AVE_ARXT=sum(ARXT_RMS_AVE(:,1))/p;        %prediction
AVE_ANNT=sum(ANNT_RMS_AVE(:,1))/p;        %prediction
AVE_ALRT=sum(ALRT_RMS_AVE(:,1))/p;        %prediction
AVE_ARXT1=sum(ARXT_RMS_AVE1(:,1))/p;      %prediction
AVE_ANNT1=sum(ANNT_RMS_AVE1(:,1))/p;      %prediction
AVE_ALRT1=sum(ALRT_RMS_AVE1(:,1))/p;      %prediction
ValAVE_ARXT=sum(ValARXT_RMS_AVE(:,1))/p;  %simulation
ValAVE_ANNT=sum(ValANNT_RMS_AVE(:,1))/p;  %simulation
ValAVE_ARXT1=sum(ValARXT_RMS_AVE1(:,1))/p;%simulation
ValAVE_ANNT1=sum(ValANNT_RMS_AVE1(:,1))/p;%simulation
ValAVE_ALRT1=sum(ValALRT_RMS_AVE1(:,1))/p;%simulation
ValAVE_ALRT=sum(ValALRT_RMS_AVE(:,1))/p;  %simulation
%% % %% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % output
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%----------------------output the simulation uncertaintie at each grids---------------------------------
dlmwrite('SIMU_STL_ALR_ICA_RMS.txt', ValALRT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_STL_ALR_PCA_RMS.txt', ValALRT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_STL_ANN_ICA_RMS.txt', ValANNT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_STL_ANN_PCA_RMS.txt', ValANNT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_STL_ARX_ICA_RMS.txt', ValARXT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('SIMU_STL_ARX_PCA_RMS.txt', ValARXT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
%----------------------output the prediction uncertainties at each grids---------------------------------
dlmwrite('PRE_STL_ALR_ICA_RMS_AVE.txt', ALRT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ALR_PCA_RMS_AVE1.txt', ALRT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ANN_ICA_RMS_AVE.txt', ANNT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ANN_PCA_RMS_AVE1.txt', ANNT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')% % %
dlmwrite('PRE_STL_ARX_ICA_RMS_AVET.txt', ARXT_RMS_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ARX_PCA_RMS_AVET1.txt', ARXT_RMS_AVE1, 'delimiter', '\t','precision','%15.5f')
%----------------------output the prediction correlation at each grids---------------------------------
dlmwrite('PRE_STL_ALR_ICA_R.txt', ALR_R_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ALR_PCA_R.txt', ALR_R_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ANN_ICA_R.txt', ANN_R_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ANN_PCA_R.txt', ANN_R_AVE1, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ARX_ICA_R.txt', ARX_R_AVE, 'delimiter', '\t','precision','%15.5f')
dlmwrite('PRE_STL_ARX_PCA_R.txt', ARX_R_AVE1, 'delimiter', '\t','precision','%15.5f')